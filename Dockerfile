...
#Install PHP7
RUN apk update && apk add php7 php7-fpm php7-gd php7-mysqli php7-zlib php7-curl php7-intl php7-openssl php7-pdo_mysql php7-pcntl php7-common php7-xsl php7-imagick php7-mysqlnd php7-enchant php7-pspell php7-redis php7-snmp php7-doc php7-mbstring php7-session php7-gd  php7-gettext  php7-json  php7-xml  php7-iconv  php7-curl  php7-phar  php7-pdo_pgsql  php7-pgsql  php7-zip  php7-mcrypt  php7-memcached php7-soap  php7-apcu php7-zlib  php7-pdo  php7-mysqli 
